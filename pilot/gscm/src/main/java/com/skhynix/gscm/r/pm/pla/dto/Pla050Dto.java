...
public class Pla050Dto {

    // ===== (nctRid 미확인) (pPLA05001) =====
    public static class Ppla05001Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla05001Response {
    ...
    // ===== (nctRid 미확인) (pPLA05002) =====
    public static class Ppla05002Request {
    ...
    public static class Ppla05002Response {
    ...
    // ===== (nctRid 미확인) (pPLA05003) =====
    public static class Ppla05003Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla05003Response {
