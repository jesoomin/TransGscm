...
public class Pla034Dto {

    // ===== (nctRid 미확인) (pPLA03401) =====
    public static class Ppla03401Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03401Response {
    ...
    // ===== (nctRid 미확인) (pPLA03402) =====
    public static class Ppla03402Request {
    ...
    public static class Ppla03402Response {
    ...
    // ===== (nctRid 미확인) (pPLA03403) =====
    public static class Ppla03403Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03403Response {
