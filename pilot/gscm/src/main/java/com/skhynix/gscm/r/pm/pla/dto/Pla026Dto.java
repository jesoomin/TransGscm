...
public class Pla026Dto {

    // ===== (nctRid 미확인) (pPLA02601) =====
    public static class Ppla02601Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02601Response {
    ...
    // ===== (nctRid 미확인) (pPLA02602) =====
    public static class Ppla02602Request {
    ...
    public static class Ppla02602Response {
    ...
    // ===== (nctRid 미확인) (pPLA02603) =====
    public static class Ppla02603Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02603Response {
