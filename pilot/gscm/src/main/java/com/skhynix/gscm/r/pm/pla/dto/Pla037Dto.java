...
public class Pla037Dto {

    // ===== (nctRid 미확인) (pPLA03701) =====
    public static class Ppla03701Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03701Response {
    ...
    // ===== (nctRid 미확인) (pPLA03702) =====
    public static class Ppla03702Request {
    ...
    public static class Ppla03702Response {
    ...
    // ===== (nctRid 미확인) (pPLA03703) =====
    public static class Ppla03703Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03703Response {
    ...
    // ===== (nctRid 미확인) (pPLA03704) =====
    public static class Ppla03704Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03704Response {
