...
public class Pla014Dto {

    // ===== (nctRid 미확인) (pPLA01401) =====
    public static class Ppla01401Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01401Response {
    ...
    // ===== (nctRid 미확인) (pPLA01402) =====
    public static class Ppla01402Request {
    ...
    public static class Ppla01402Response {
    ...
    // ===== (nctRid 미확인) (pPLA01403) =====
    public static class Ppla01403Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01403Response {
