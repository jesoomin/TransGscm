...
public class Pla011Dto {

    // ===== (nctRid 미확인) (pPLA01101) =====
    public static class Ppla01101Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01101Response {
    ...
    // ===== (nctRid 미확인) (pPLA01102) =====
    public static class Ppla01102Request {
    ...
    public static class Ppla01102Response {
    ...
    // ===== (nctRid 미확인) (pPLA01103) =====
    public static class Ppla01103Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01103Response {
    ...
    // ===== (nctRid 미확인) (pPLA01104) =====
    public static class Ppla01104Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01104Response {
