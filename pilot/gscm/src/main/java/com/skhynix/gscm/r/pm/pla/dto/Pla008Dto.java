...
public class Pla008Dto {

    // ===== (nctRid 미확인) (pPLA00801) =====
    public static class Ppla00801Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00801Response {
    ...
    // ===== (nctRid 미확인) (pPLA00802) =====
    public static class Ppla00802Request {
    ...
    public static class Ppla00802Response {
    ...
    // ===== (nctRid 미확인) (pPLA00803) =====
    public static class Ppla00803Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00803Response {
