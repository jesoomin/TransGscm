...
public class Pla030Dto {

    // ===== (nctRid 미확인) (pPLA03001) =====
    public static class Ppla03001Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03001Response {
    ...
    // ===== (nctRid 미확인) (pPLA03002) =====
    public static class Ppla03002Request {
    ...
    public static class Ppla03002Response {
    ...
    // ===== (nctRid 미확인) (pPLA03003) =====
    public static class Ppla03003Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03003Response {
