...
public class Pla048Dto {
    ...
    // ===== (nctRid 미확인) (pPLA04801) =====
    public static class Ppla04801Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla04801Response {
    ...
    // ===== (nctRid 미확인) (pPLA04802) =====
    public static class Ppla04802Request {
    ...
    public static class Ppla04802Response {
    ...
    // ===== (nctRid 미확인) (pPLA04803) =====
    public static class Ppla04803Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla04803Response {
