...
public class Pla042Dto {

    // ===== (nctRid 미확인) (pPLA04201) =====
    public static class Ppla04201Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla04201Response {
    ...
    // ===== (nctRid 미확인) (pPLA04202) =====
    public static class Ppla04202Request {
    ...
    public static class Ppla04202Response {
    ...
    // ===== (nctRid 미확인) (pPLA04203) =====
    public static class Ppla04203Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla04203Response {
