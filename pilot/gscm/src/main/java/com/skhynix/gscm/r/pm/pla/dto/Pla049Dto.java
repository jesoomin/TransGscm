...
public class Pla049Dto {

    // ===== (nctRid 미확인) (pPLA04901) =====
    public static class Ppla04901Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla04901Response {
    ...
    // ===== (nctRid 미확인) (pPLA04902) =====
    public static class Ppla04902Request {
    ...
    public static class Ppla04902Response {
    ...
    // ===== (nctRid 미확인) (pPLA04903) =====
    public static class Ppla04903Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla04903Response {
    ...
    // ===== (nctRid 미확인) (pPLA04904) =====
    public static class Ppla04904Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla04904Response {
