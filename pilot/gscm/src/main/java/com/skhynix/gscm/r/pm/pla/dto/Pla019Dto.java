...
public class Pla019Dto {

    // ===== (nctRid 미확인) (pPLA01901) =====
    public static class Ppla01901Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01901Response {
    ...
    // ===== (nctRid 미확인) (pPLA01902) =====
    public static class Ppla01902Request {
    ...
    public static class Ppla01902Response {
    ...
    // ===== (nctRid 미확인) (pPLA01903) =====
    public static class Ppla01903Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01903Response {
    ...
    // ===== (nctRid 미확인) (pPLA01904) =====
    public static class Ppla01904Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01904Response {
