...
public class Pla010Dto {

    // ===== (nctRid 미확인) (pPLA01001) =====
    public static class Ppla01001Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01001Response {
    ...
    // ===== (nctRid 미확인) (pPLA01002) =====
    public static class Ppla01002Request {
    ...
    public static class Ppla01002Response {
    ...
    // ===== (nctRid 미확인) (pPLA01003) =====
    public static class Ppla01003Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01003Response {
