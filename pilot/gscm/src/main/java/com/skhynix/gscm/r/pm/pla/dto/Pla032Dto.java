...
public class Pla032Dto {

    // ===== (nctRid 미확인) (pPLA03201) =====
    public static class Ppla03201Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03201Response {
    ...
    // ===== (nctRid 미확인) (pPLA03202) =====
    public static class Ppla03202Request {
    ...
    public static class Ppla03202Response {
    ...
    // ===== (nctRid 미확인) (pPLA03203) =====
    public static class Ppla03203Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03203Response {
