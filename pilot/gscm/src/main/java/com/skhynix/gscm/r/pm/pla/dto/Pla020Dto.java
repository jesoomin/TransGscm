...
public class Pla020Dto {

    // ===== (nctRid 미확인) (pPLA02001) =====
    public static class Ppla02001Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02001Response {
    ...
    // ===== (nctRid 미확인) (pPLA02002) =====
    public static class Ppla02002Request {
    ...
    public static class Ppla02002Response {
    ...
    // ===== (nctRid 미확인) (pPLA02003) =====
    public static class Ppla02003Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02003Response {
