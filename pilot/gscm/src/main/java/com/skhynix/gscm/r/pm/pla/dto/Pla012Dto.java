...
public class Pla012Dto {

    // ===== (nctRid 미확인) (pPLA01201) =====
    public static class Ppla01201Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01201Response {
    ...
    // ===== (nctRid 미확인) (pPLA01202) =====
    public static class Ppla01202Request {
    ...
    public static class Ppla01202Response {
    ...
    // ===== (nctRid 미확인) (pPLA01203) =====
    public static class Ppla01203Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01203Response {
