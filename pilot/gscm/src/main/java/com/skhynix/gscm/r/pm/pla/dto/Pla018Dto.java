...
public class Pla018Dto {

    // ===== (nctRid 미확인) (pPLA01801) =====
    public static class Ppla01801Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01801Response {
    ...
    // ===== (nctRid 미확인) (pPLA01802) =====
    public static class Ppla01802Request {
    ...
    public static class Ppla01802Response {
    ...
    // ===== (nctRid 미확인) (pPLA01803) =====
    public static class Ppla01803Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01803Response {
