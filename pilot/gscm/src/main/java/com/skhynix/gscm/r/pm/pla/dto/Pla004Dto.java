...
public class Pla004Dto {

    // ===== (nctRid 미확인) (pPLA00401) =====
    public static class Ppla00401Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00401Response {
    ...
    // ===== (nctRid 미확인) (pPLA00402) =====
    public static class Ppla00402Request {
    ...
    public static class Ppla00402Response {
    ...
    // ===== (nctRid 미확인) (pPLA00403) =====
    public static class Ppla00403Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00403Response {
