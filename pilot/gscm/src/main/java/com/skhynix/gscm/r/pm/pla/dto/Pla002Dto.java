...
public class Pla002Dto {

    // ===== (nctRid 미확인) (pPLA00201) =====
    public static class Ppla00201Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00201Response {
    ...
    // ===== (nctRid 미확인) (pPLA00202) =====
    public static class Ppla00202Request {
    ...
    public static class Ppla00202Response {
    ...
    // ===== (nctRid 미확인) (pPLA00203) =====
    public static class Ppla00203Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00203Response {
