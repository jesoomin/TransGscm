...
public class Pla003Dto {

    // ===== (nctRid 미확인) (pPLA00301) =====
    public static class Ppla00301Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00301Response {
    ...
    // ===== (nctRid 미확인) (pPLA00302) =====
    public static class Ppla00302Request {
    ...
    public static class Ppla00302Response {
    ...
    // ===== (nctRid 미확인) (pPLA00303) =====
    public static class Ppla00303Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00303Response {
    ...
    // ===== (nctRid 미확인) (pPLA00304) =====
    public static class Ppla00304Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00304Response {
