...
public class Pla029Dto {

    // ===== (nctRid 미확인) (pPLA02901) =====
    public static class Ppla02901Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02901Response {
    ...
    // ===== (nctRid 미확인) (pPLA02902) =====
    public static class Ppla02902Request {
    ...
    public static class Ppla02902Response {
    ...
    // ===== (nctRid 미확인) (pPLA02903) =====
    public static class Ppla02903Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02903Response {
    ...
    // ===== (nctRid 미확인) (pPLA02904) =====
    public static class Ppla02904Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02904Response {
