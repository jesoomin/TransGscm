...
public class Pla006Dto {

    // ===== (nctRid 미확인) (pPLA00601) =====
    public static class Ppla00601Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00601Response {
    ...
    // ===== (nctRid 미확인) (pPLA00602) =====
    public static class Ppla00602Request {
    ...
    public static class Ppla00602Response {
    ...
    // ===== (nctRid 미확인) (pPLA00603) =====
    public static class Ppla00603Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00603Response {
