...
public class Pla041Dto {

    // ===== (nctRid 미확인) (pPLA04101) =====
    public static class Ppla04101Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla04101Response {
    ...
    // ===== (nctRid 미확인) (pPLA04102) =====
    public static class Ppla04102Request {
    ...
    public static class Ppla04102Response {
    ...
    // ===== (nctRid 미확인) (pPLA04103) =====
    public static class Ppla04103Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla04103Response {
    ...
    // ===== (nctRid 미확인) (pPLA04104) =====
    public static class Ppla04104Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla04104Response {
