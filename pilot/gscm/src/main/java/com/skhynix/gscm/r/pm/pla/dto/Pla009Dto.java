...
public class Pla009Dto {

    // ===== (nctRid 미확인) (pPLA00901) =====
    public static class Ppla00901Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00901Response {
    ...
    // ===== (nctRid 미확인) (pPLA00902) =====
    public static class Ppla00902Request {
    ...
    public static class Ppla00902Response {
    ...
    // ===== (nctRid 미확인) (pPLA00903) =====
    public static class Ppla00903Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00903Response {
    ...
    // ===== (nctRid 미확인) (pPLA00904) =====
    public static class Ppla00904Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00904Response {
