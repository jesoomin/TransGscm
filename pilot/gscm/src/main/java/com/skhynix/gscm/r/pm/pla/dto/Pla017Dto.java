...
public class Pla017Dto {

    // ===== (nctRid 미확인) (pPLA01701) =====
    public static class Ppla01701Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01701Response {
    ...
    // ===== (nctRid 미확인) (pPLA01702) =====
    public static class Ppla01702Request {
    ...
    public static class Ppla01702Response {
    ...
    // ===== (nctRid 미확인) (pPLA01703) =====
    public static class Ppla01703Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01703Response {
    ...
    // ===== (nctRid 미확인) (pPLA01704) =====
    public static class Ppla01704Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01704Response {
