...
public class Pla040Dto {

    // ===== (nctRid 미확인) (pPLA04001) =====
    public static class Ppla04001Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla04001Response {
    ...
    // ===== (nctRid 미확인) (pPLA04002) =====
    public static class Ppla04002Request {
    ...
    public static class Ppla04002Response {
    ...
    // ===== (nctRid 미확인) (pPLA04003) =====
    public static class Ppla04003Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla04003Response {
