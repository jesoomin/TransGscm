...
public class Pla013Dto {

    // ===== (nctRid 미확인) (pPLA01301) =====
    public static class Ppla01301Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01301Response {
    ...
    // ===== (nctRid 미확인) (pPLA01302) =====
    public static class Ppla01302Request {
    ...
    public static class Ppla01302Response {
    ...
    // ===== (nctRid 미확인) (pPLA01303) =====
    public static class Ppla01303Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01303Response {
    ...
    // ===== (nctRid 미확인) (pPLA01304) =====
    public static class Ppla01304Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01304Response {
