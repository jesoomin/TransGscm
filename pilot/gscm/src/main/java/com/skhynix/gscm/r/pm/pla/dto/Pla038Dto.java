...
public class Pla038Dto {

    // ===== (nctRid 미확인) (pPLA03801) =====
    public static class Ppla03801Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03801Response {
    ...
    // ===== (nctRid 미확인) (pPLA03802) =====
    public static class Ppla03802Request {
    ...
    public static class Ppla03802Response {
    ...
    // ===== (nctRid 미확인) (pPLA03803) =====
    public static class Ppla03803Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03803Response {
