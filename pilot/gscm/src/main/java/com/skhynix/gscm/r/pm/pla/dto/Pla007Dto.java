...
public class Pla007Dto {

    // ===== (nctRid 미확인) (pPLA00701) =====
    public static class Ppla00701Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00701Response {
    ...
    // ===== (nctRid 미확인) (pPLA00702) =====
    public static class Ppla00702Request {
    ...
    public static class Ppla00702Response {
    ...
    // ===== (nctRid 미확인) (pPLA00703) =====
    public static class Ppla00703Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00703Response {
    ...
    // ===== (nctRid 미확인) (pPLA00704) =====
    public static class Ppla00704Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00704Response {
