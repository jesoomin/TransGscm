...
public class Pla021Dto {

    // ===== (nctRid 미확인) (pPLA02101) =====
    public static class Ppla02101Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02101Response {
    ...
    // ===== (nctRid 미확인) (pPLA02102) =====
    public static class Ppla02102Request {
    ...
    public static class Ppla02102Response {
    ...
    // ===== (nctRid 미확인) (pPLA02103) =====
    public static class Ppla02103Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02103Response {
    ...
    // ===== (nctRid 미확인) (pPLA02104) =====
    public static class Ppla02104Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02104Response {
