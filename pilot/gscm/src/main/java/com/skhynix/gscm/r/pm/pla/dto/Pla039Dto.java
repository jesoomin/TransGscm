...
public class Pla039Dto {

    // ===== (nctRid 미확인) (pPLA03901) =====
    public static class Ppla03901Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03901Response {
    ...
    // ===== (nctRid 미확인) (pPLA03902) =====
    public static class Ppla03902Request {
    ...
    public static class Ppla03902Response {
    ...
    // ===== (nctRid 미확인) (pPLA03903) =====
    public static class Ppla03903Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03903Response {
    ...
    // ===== (nctRid 미확인) (pPLA03904) =====
    public static class Ppla03904Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03904Response {
