...
public class Pla031Dto {

    // ===== (nctRid 미확인) (pPLA03101) =====
    public static class Ppla03101Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03101Response {
    ...
    // ===== (nctRid 미확인) (pPLA03102) =====
    public static class Ppla03102Request {
    ...
    public static class Ppla03102Response {
    ...
    // ===== (nctRid 미확인) (pPLA03103) =====
    public static class Ppla03103Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03103Response {
    ...
    // ===== (nctRid 미확인) (pPLA03104) =====
    public static class Ppla03104Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03104Response {
