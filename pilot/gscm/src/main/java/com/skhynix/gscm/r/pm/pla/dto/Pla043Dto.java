...
public class Pla043Dto {

    // ===== (nctRid 미확인) (pPLA04301) =====
    public static class Ppla04301Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla04301Response {
    ...
    // ===== (nctRid 미확인) (pPLA04302) =====
    public static class Ppla04302Request {
    ...
    public static class Ppla04302Response {
    ...
    // ===== (nctRid 미확인) (pPLA04303) =====
    public static class Ppla04303Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla04303Response {
    ...
    // ===== (nctRid 미확인) (pPLA04304) =====
    public static class Ppla04304Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla04304Response {
