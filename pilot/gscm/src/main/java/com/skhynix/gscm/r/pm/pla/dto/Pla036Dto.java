...
public class Pla036Dto {

    // ===== (nctRid 미확인) (pPLA03601) =====
    public static class Ppla03601Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03601Response {
    ...
    // ===== (nctRid 미확인) (pPLA03602) =====
    public static class Ppla03602Request {
    ...
    public static class Ppla03602Response {
    ...
    // ===== (nctRid 미확인) (pPLA03603) =====
    public static class Ppla03603Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03603Response {
