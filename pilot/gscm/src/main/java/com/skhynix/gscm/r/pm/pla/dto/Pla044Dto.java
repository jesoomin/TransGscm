...
public class Pla044Dto {

    // ===== (nctRid 미확인) (pPLA04401) =====
    public static class Ppla04401Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla04401Response {
    ...
    // ===== (nctRid 미확인) (pPLA04402) =====
    public static class Ppla04402Request {
    ...
    public static class Ppla04402Response {
    ...
    // ===== (nctRid 미확인) (pPLA04403) =====
    public static class Ppla04403Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla04403Response {
