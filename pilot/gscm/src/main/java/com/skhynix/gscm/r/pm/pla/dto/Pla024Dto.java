...
public class Pla024Dto {

    // ===== (nctRid 미확인) (pPLA02401) =====
    public static class Ppla02401Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02401Response {
    ...
    // ===== (nctRid 미확인) (pPLA02402) =====
    public static class Ppla02402Request {
    ...
    public static class Ppla02402Response {
    ...
    // ===== (nctRid 미확인) (pPLA02403) =====
    public static class Ppla02403Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02403Response {
