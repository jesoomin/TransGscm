...
public class Pla025Dto {

    // ===== (nctRid 미확인) (pPLA02501) =====
    public static class Ppla02501Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02501Response {
    ...
    // ===== (nctRid 미확인) (pPLA02502) =====
    public static class Ppla02502Request {
    ...
    public static class Ppla02502Response {
    ...
    // ===== (nctRid 미확인) (pPLA02503) =====
    public static class Ppla02503Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02503Response {
    ...
    // ===== (nctRid 미확인) (pPLA02504) =====
    public static class Ppla02504Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02504Response {
