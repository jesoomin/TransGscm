...
public class Pla028Dto {

    // ===== (nctRid 미확인) (pPLA02801) =====
    public static class Ppla02801Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02801Response {
    ...
    // ===== (nctRid 미확인) (pPLA02802) =====
    public static class Ppla02802Request {
    ...
    public static class Ppla02802Response {
    ...
    // ===== (nctRid 미확인) (pPLA02803) =====
    public static class Ppla02803Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02803Response {
