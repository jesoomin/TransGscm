...
public class Pla005Dto {

    // ===== (nctRid 미확인) (pPLA00501) =====
    public static class Ppla00501Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00501Response {
    ...
    // ===== (nctRid 미확인) (pPLA00502) =====
    public static class Ppla00502Request {
    ...
    public static class Ppla00502Response {
    ...
    // ===== (nctRid 미확인) (pPLA00503) =====
    public static class Ppla00503Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00503Response {
    ...
    // ===== (nctRid 미확인) (pPLA00504) =====
    public static class Ppla00504Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00504Response {
