...
public class Pla016Dto {

    // ===== (nctRid 미확인) (pPLA01601) =====
    public static class Ppla01601Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01601Response {
    ...
    // ===== (nctRid 미확인) (pPLA01602) =====
    public static class Ppla01602Request {
    ...
    public static class Ppla01602Response {
    ...
    // ===== (nctRid 미확인) (pPLA01603) =====
    public static class Ppla01603Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01603Response {
