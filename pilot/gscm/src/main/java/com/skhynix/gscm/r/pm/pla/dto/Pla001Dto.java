...
public class Pla001Dto {

    // ===== (nctRid 미확인) (pPLA00101) =====
    public static class Ppla00101Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00101Response {
    ...
    // ===== (nctRid 미확인) (pPLA00102) =====
    public static class Ppla00102Request {
    ...
    public static class Ppla00102Response {
    ...
    // ===== (nctRid 미확인) (pPLA00103) =====
    public static class Ppla00103Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00103Response {
    ...
    // ===== (nctRid 미확인) (pPLA00104) =====
    public static class Ppla00104Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla00104Response {
