...
public class Pla022Dto {

    // ===== (nctRid 미확인) (pPLA02201) =====
    public static class Ppla02201Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02201Response {
    ...
    // ===== (nctRid 미확인) (pPLA02202) =====
    public static class Ppla02202Request {
    ...
    public static class Ppla02202Response {
    ...
    // ===== (nctRid 미확인) (pPLA02203) =====
    public static class Ppla02203Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02203Response {
