...
public class Pla033Dto {

    // ===== (nctRid 미확인) (pPLA03301) =====
    public static class Ppla03301Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03301Response {
    ...
    // ===== (nctRid 미확인) (pPLA03302) =====
    public static class Ppla03302Request {
    ...
    public static class Ppla03302Response {
    ...
    // ===== (nctRid 미확인) (pPLA03303) =====
    public static class Ppla03303Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03303Response {
    ...
    // ===== (nctRid 미확인) (pPLA03304) =====
    public static class Ppla03304Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03304Response {
