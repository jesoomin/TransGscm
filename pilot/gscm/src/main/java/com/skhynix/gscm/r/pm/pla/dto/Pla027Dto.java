...
public class Pla027Dto {

    // ===== (nctRid 미확인) (pPLA02701) =====
    public static class Ppla02701Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02701Response {
    ...
    // ===== (nctRid 미확인) (pPLA02702) =====
    public static class Ppla02702Request {
    ...
    public static class Ppla02702Response {
    ...
    // ===== (nctRid 미확인) (pPLA02703) =====
    public static class Ppla02703Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02703Response {
    ...
    // ===== (nctRid 미확인) (pPLA02704) =====
    public static class Ppla02704Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla02704Response {
