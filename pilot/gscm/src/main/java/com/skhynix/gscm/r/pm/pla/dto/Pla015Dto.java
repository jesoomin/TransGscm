...
public class Pla015Dto {

    // ===== (nctRid 미확인) (pPLA01501) =====
    public static class Ppla01501Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01501Response {
    ...
    // ===== (nctRid 미확인) (pPLA01502) =====
    public static class Ppla01502Request {
    ...
    public static class Ppla01502Response {
    ...
    // ===== (nctRid 미확인) (pPLA01503) =====
    public static class Ppla01503Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01503Response {
    ...
    // ===== (nctRid 미확인) (pPLA01504) =====
    public static class Ppla01504Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla01504Response {
