...
public class Pla035Dto {

    // ===== (nctRid 미확인) (pPLA03501) =====
    public static class Ppla03501Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03501Response {
    ...
    // ===== (nctRid 미확인) (pPLA03502) =====
    public static class Ppla03502Request {
    ...
    public static class Ppla03502Response {
    ...
    // ===== (nctRid 미확인) (pPLA03503) =====
    public static class Ppla03503Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03503Response {
    ...
    // ===== (nctRid 미확인) (pPLA03504) =====
    public static class Ppla03504Request {
        // TODO: 요청 필드 자동 추출 실패 - 원본 대조해서 수동으로 채울 것
    }

    public static class Ppla03504Response {
