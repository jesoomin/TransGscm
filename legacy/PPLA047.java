...
*/
public class PPLA047 extends gscm.fwk.base.ProcessUnit{
	public PPLA047(){
		super();
	}
	...
	*/
	public IDataSet pPLA04701 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA047 fu = (FPLA047) lookupFunctionUnit(FPLA047.class);
			IDataSet ds = fu.fPLA047QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA04702 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA047 fu = (FPLA047) lookupFunctionUnit(FPLA047.class);
			IDataSet ds = fu.fPLA047QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA04703 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA047 fu = (FPLA047) lookupFunctionUnit(FPLA047.class);
			IDataSet ds = fu.fPLA047QrySelectRevPeriod(requestData, onlineCtx);
