...
*/
public class PPLA008 extends gscm.fwk.base.ProcessUnit{
	public PPLA008(){
		super();
	}
	...
	*/
	public IDataSet pPLA00801 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA008 fu = (FPLA008) lookupFunctionUnit(FPLA008.class);
			IDataSet ds = fu.fPLA008QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA00802 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA008 fu = (FPLA008) lookupFunctionUnit(FPLA008.class);
			IDataSet ds = fu.fPLA008QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA00803 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA008 fu = (FPLA008) lookupFunctionUnit(FPLA008.class);
			IDataSet ds = fu.fPLA008QrySelectRevPeriod(requestData, onlineCtx);
