...
*/
public class PPLA007 extends gscm.fwk.base.ProcessUnit{
	public PPLA007(){
		super();
	}
	...
	*/
	public IDataSet pPLA00701 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA007 fu = (FPLA007) lookupFunctionUnit(FPLA007.class);
			IDataSet ds = fu.fPLA007QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA00702 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA007 fu = (FPLA007) lookupFunctionUnit(FPLA007.class);
			IDataSet ds = fu.fPLA007QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA00703 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA007 fu = (FPLA007) lookupFunctionUnit(FPLA007.class);
			IDataSet ds = fu.fPLA007QrySelectRevPeriod(requestData, onlineCtx);
