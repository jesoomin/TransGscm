...
*/
public class PPLA046 extends gscm.fwk.base.ProcessUnit{
	public PPLA046(){
		super();
	}
	...
	*/
	public IDataSet pPLA04601 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA046 fu = (FPLA046) lookupFunctionUnit(FPLA046.class);
			IDataSet ds = fu.fPLA046QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA04602 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA046 fu = (FPLA046) lookupFunctionUnit(FPLA046.class);
			IDataSet ds = fu.fPLA046QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA04603 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA046 fu = (FPLA046) lookupFunctionUnit(FPLA046.class);
			IDataSet ds = fu.fPLA046QrySelectRevPeriod(requestData, onlineCtx);
