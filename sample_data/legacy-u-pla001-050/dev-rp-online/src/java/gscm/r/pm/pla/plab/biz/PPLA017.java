...
*/
public class PPLA017 extends gscm.fwk.base.ProcessUnit{
	public PPLA017(){
		super();
	}
	...
	*/
	public IDataSet pPLA01701 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA017 fu = (FPLA017) lookupFunctionUnit(FPLA017.class);
			IDataSet ds = fu.fPLA017QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA01702 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA017 fu = (FPLA017) lookupFunctionUnit(FPLA017.class);
			IDataSet ds = fu.fPLA017QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA01703 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA017 fu = (FPLA017) lookupFunctionUnit(FPLA017.class);
			IDataSet ds = fu.fPLA017QrySelectRevPeriod(requestData, onlineCtx);
