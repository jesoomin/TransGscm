...
*/
public class PPLA015 extends gscm.fwk.base.ProcessUnit{
	public PPLA015(){
		super();
	}
	...
	*/
	public IDataSet pPLA01501 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA015 fu = (FPLA015) lookupFunctionUnit(FPLA015.class);
			IDataSet ds = fu.fPLA015QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA01502 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA015 fu = (FPLA015) lookupFunctionUnit(FPLA015.class);
			IDataSet ds = fu.fPLA015QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA01503 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA015 fu = (FPLA015) lookupFunctionUnit(FPLA015.class);
			IDataSet ds = fu.fPLA015QrySelectRevPeriod(requestData, onlineCtx);
