...
*/
public class DPLA004 extends gscm.fwk.base.ProcessUnit{
	public DPLA004(){
		super();
	}
	...
	*/
	public IDataSet dPLA00401(IDataSet requestData, IOnlineContext onlineCtx){
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA00402(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA00403(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA00404(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA00405(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA00406(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
