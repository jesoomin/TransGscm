...
*/
public class PPLA027 extends gscm.fwk.base.ProcessUnit{
	public PPLA027(){
		super();
	}
	...
	*/
	public IDataSet pPLA02701 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA027 fu = (FPLA027) lookupFunctionUnit(FPLA027.class);
			IDataSet ds = fu.fPLA027QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA02702 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA027 fu = (FPLA027) lookupFunctionUnit(FPLA027.class);
			IDataSet ds = fu.fPLA027QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA02703 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA027 fu = (FPLA027) lookupFunctionUnit(FPLA027.class);
			IDataSet ds = fu.fPLA027QrySelectRevPeriod(requestData, onlineCtx);
