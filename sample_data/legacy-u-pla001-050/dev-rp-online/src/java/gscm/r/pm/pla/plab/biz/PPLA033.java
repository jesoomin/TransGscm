...
*/
public class PPLA033 extends gscm.fwk.base.ProcessUnit{
	public PPLA033(){
		super();
	}
	...
	*/
	public IDataSet pPLA03301 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA033 fu = (FPLA033) lookupFunctionUnit(FPLA033.class);
			IDataSet ds = fu.fPLA033QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA03302 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA033 fu = (FPLA033) lookupFunctionUnit(FPLA033.class);
			IDataSet ds = fu.fPLA033QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA03303 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA033 fu = (FPLA033) lookupFunctionUnit(FPLA033.class);
			IDataSet ds = fu.fPLA033QrySelectRevPeriod(requestData, onlineCtx);
