...
*/
public class PPLA014 extends gscm.fwk.base.ProcessUnit{
	public PPLA014(){
		super();
	}
	...
	*/
	public IDataSet pPLA01401 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA014 fu = (FPLA014) lookupFunctionUnit(FPLA014.class);
			IDataSet ds = fu.fPLA014QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA01402 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA014 fu = (FPLA014) lookupFunctionUnit(FPLA014.class);
			IDataSet ds = fu.fPLA014QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA01403 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA014 fu = (FPLA014) lookupFunctionUnit(FPLA014.class);
			IDataSet ds = fu.fPLA014QrySelectRevPeriod(requestData, onlineCtx);
