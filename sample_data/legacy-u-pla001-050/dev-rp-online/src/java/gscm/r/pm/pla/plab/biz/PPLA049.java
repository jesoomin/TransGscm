...
*/
public class PPLA049 extends gscm.fwk.base.ProcessUnit{
	public PPLA049(){
		super();
	}
	...
	*/
	public IDataSet pPLA04901 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA049 fu = (FPLA049) lookupFunctionUnit(FPLA049.class);
			IDataSet ds = fu.fPLA049QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA04902 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA049 fu = (FPLA049) lookupFunctionUnit(FPLA049.class);
			IDataSet ds = fu.fPLA049QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA04903 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA049 fu = (FPLA049) lookupFunctionUnit(FPLA049.class);
			IDataSet ds = fu.fPLA049QrySelectRevPeriod(requestData, onlineCtx);
