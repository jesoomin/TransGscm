...
*/
public class PPLA025 extends gscm.fwk.base.ProcessUnit{
	public PPLA025(){
		super();
	}
	...
	*/
	public IDataSet pPLA02501 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA025 fu = (FPLA025) lookupFunctionUnit(FPLA025.class);
			IDataSet ds = fu.fPLA025QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA02502 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA025 fu = (FPLA025) lookupFunctionUnit(FPLA025.class);
			IDataSet ds = fu.fPLA025QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA02503 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA025 fu = (FPLA025) lookupFunctionUnit(FPLA025.class);
			IDataSet ds = fu.fPLA025QrySelectRevPeriod(requestData, onlineCtx);
