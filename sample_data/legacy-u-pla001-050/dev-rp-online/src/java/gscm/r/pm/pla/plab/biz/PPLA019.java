...
*/
public class PPLA019 extends gscm.fwk.base.ProcessUnit{
	public PPLA019(){
		super();
	}
	...
	*/
	public IDataSet pPLA01901 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA019 fu = (FPLA019) lookupFunctionUnit(FPLA019.class);
			IDataSet ds = fu.fPLA019QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA01902 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA019 fu = (FPLA019) lookupFunctionUnit(FPLA019.class);
			IDataSet ds = fu.fPLA019QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA01903 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA019 fu = (FPLA019) lookupFunctionUnit(FPLA019.class);
			IDataSet ds = fu.fPLA019QrySelectRevPeriod(requestData, onlineCtx);
