...
*/
public class PPLA021 extends gscm.fwk.base.ProcessUnit{
	public PPLA021(){
		super();
	}
	...
	*/
	public IDataSet pPLA02101 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA021 fu = (FPLA021) lookupFunctionUnit(FPLA021.class);
			IDataSet ds = fu.fPLA021QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA02102 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA021 fu = (FPLA021) lookupFunctionUnit(FPLA021.class);
			IDataSet ds = fu.fPLA021QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA02103 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA021 fu = (FPLA021) lookupFunctionUnit(FPLA021.class);
			IDataSet ds = fu.fPLA021QrySelectRevPeriod(requestData, onlineCtx);
