...
*/
public class PPLA035 extends gscm.fwk.base.ProcessUnit{
	public PPLA035(){
		super();
	}
	...
	*/
	public IDataSet pPLA03501 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA035 fu = (FPLA035) lookupFunctionUnit(FPLA035.class);
			IDataSet ds = fu.fPLA035QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA03502 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA035 fu = (FPLA035) lookupFunctionUnit(FPLA035.class);
			IDataSet ds = fu.fPLA035QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA03503 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA035 fu = (FPLA035) lookupFunctionUnit(FPLA035.class);
			IDataSet ds = fu.fPLA035QrySelectRevPeriod(requestData, onlineCtx);
