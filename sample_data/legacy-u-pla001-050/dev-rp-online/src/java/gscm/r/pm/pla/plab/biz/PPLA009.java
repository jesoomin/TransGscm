...
*/
public class PPLA009 extends gscm.fwk.base.ProcessUnit{
	public PPLA009(){
		super();
	}
	...
	*/
	public IDataSet pPLA00901 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA009 fu = (FPLA009) lookupFunctionUnit(FPLA009.class);
			IDataSet ds = fu.fPLA009QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA00902 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA009 fu = (FPLA009) lookupFunctionUnit(FPLA009.class);
			IDataSet ds = fu.fPLA009QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA00903 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA009 fu = (FPLA009) lookupFunctionUnit(FPLA009.class);
			IDataSet ds = fu.fPLA009QrySelectRevPeriod(requestData, onlineCtx);
