...
*/
public class PPLA034 extends gscm.fwk.base.ProcessUnit{
	public PPLA034(){
		super();
	}
	...
	*/
	public IDataSet pPLA03401 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA034 fu = (FPLA034) lookupFunctionUnit(FPLA034.class);
			IDataSet ds = fu.fPLA034QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA03402 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA034 fu = (FPLA034) lookupFunctionUnit(FPLA034.class);
			IDataSet ds = fu.fPLA034QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA03403 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA034 fu = (FPLA034) lookupFunctionUnit(FPLA034.class);
			IDataSet ds = fu.fPLA034QrySelectRevPeriod(requestData, onlineCtx);
