...
*/
public class PPLA042 extends gscm.fwk.base.ProcessUnit{
	public PPLA042(){
		super();
	}
	...
	*/
	public IDataSet pPLA04201 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA042 fu = (FPLA042) lookupFunctionUnit(FPLA042.class);
			IDataSet ds = fu.fPLA042QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA04202 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA042 fu = (FPLA042) lookupFunctionUnit(FPLA042.class);
			IDataSet ds = fu.fPLA042QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA04203 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA042 fu = (FPLA042) lookupFunctionUnit(FPLA042.class);
			IDataSet ds = fu.fPLA042QrySelectRevPeriod(requestData, onlineCtx);
