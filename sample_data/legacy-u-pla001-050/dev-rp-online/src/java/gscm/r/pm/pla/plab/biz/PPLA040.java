...
*/
public class PPLA040 extends gscm.fwk.base.ProcessUnit{
	public PPLA040(){
		super();
	}
	...
	*/
	public IDataSet pPLA04001 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA040 fu = (FPLA040) lookupFunctionUnit(FPLA040.class);
			IDataSet ds = fu.fPLA040QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA04002 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA040 fu = (FPLA040) lookupFunctionUnit(FPLA040.class);
			IDataSet ds = fu.fPLA040QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA04003 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA040 fu = (FPLA040) lookupFunctionUnit(FPLA040.class);
			IDataSet ds = fu.fPLA040QrySelectRevPeriod(requestData, onlineCtx);
