...
*/
public class PPLA003 extends gscm.fwk.base.ProcessUnit{
	public PPLA003(){
		super();
	}
	...
	*/
	public IDataSet pPLA00301 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA003 fu = (FPLA003) lookupFunctionUnit(FPLA003.class);
			IDataSet ds = fu.fPLA003QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA00302 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA003 fu = (FPLA003) lookupFunctionUnit(FPLA003.class);
			IDataSet ds = fu.fPLA003QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA00303 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA003 fu = (FPLA003) lookupFunctionUnit(FPLA003.class);
			IDataSet ds = fu.fPLA003QrySelectRevPeriod(requestData, onlineCtx);
