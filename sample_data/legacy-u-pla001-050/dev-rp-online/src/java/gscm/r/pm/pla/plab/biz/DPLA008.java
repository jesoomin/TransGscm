...
*/
public class DPLA008 extends gscm.fwk.base.ProcessUnit{
	public DPLA008(){
		super();
	}
	...
	*/
	public IDataSet dPLA00801(IDataSet requestData, IOnlineContext onlineCtx){
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA00802(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA00803(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA00804(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA00805(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA00806(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
