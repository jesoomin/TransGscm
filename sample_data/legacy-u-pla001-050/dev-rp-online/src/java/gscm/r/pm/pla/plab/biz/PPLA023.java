...
*/
public class PPLA023 extends gscm.fwk.base.ProcessUnit{
	public PPLA023(){
		super();
	}
	...
	*/
	public IDataSet pPLA02301 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA023 fu = (FPLA023) lookupFunctionUnit(FPLA023.class);
			IDataSet ds = fu.fPLA023QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA02302 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA023 fu = (FPLA023) lookupFunctionUnit(FPLA023.class);
			IDataSet ds = fu.fPLA023QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA02303 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA023 fu = (FPLA023) lookupFunctionUnit(FPLA023.class);
			IDataSet ds = fu.fPLA023QrySelectRevPeriod(requestData, onlineCtx);
