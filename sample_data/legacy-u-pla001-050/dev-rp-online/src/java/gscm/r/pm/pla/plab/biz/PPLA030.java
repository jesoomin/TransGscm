...
*/
public class PPLA030 extends gscm.fwk.base.ProcessUnit{
	public PPLA030(){
		super();
	}
	...
	*/
	public IDataSet pPLA03001 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA030 fu = (FPLA030) lookupFunctionUnit(FPLA030.class);
			IDataSet ds = fu.fPLA030QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA03002 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA030 fu = (FPLA030) lookupFunctionUnit(FPLA030.class);
			IDataSet ds = fu.fPLA030QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA03003 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA030 fu = (FPLA030) lookupFunctionUnit(FPLA030.class);
			IDataSet ds = fu.fPLA030QrySelectRevPeriod(requestData, onlineCtx);
