...
*/
public class PPLA024 extends gscm.fwk.base.ProcessUnit{
	public PPLA024(){
		super();
	}
	...
	*/
	public IDataSet pPLA02401 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA024 fu = (FPLA024) lookupFunctionUnit(FPLA024.class);
			IDataSet ds = fu.fPLA024QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA02402 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA024 fu = (FPLA024) lookupFunctionUnit(FPLA024.class);
			IDataSet ds = fu.fPLA024QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA02403 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA024 fu = (FPLA024) lookupFunctionUnit(FPLA024.class);
			IDataSet ds = fu.fPLA024QrySelectRevPeriod(requestData, onlineCtx);
