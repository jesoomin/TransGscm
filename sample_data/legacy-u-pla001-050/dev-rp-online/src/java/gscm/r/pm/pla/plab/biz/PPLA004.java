...
*/
public class PPLA004 extends gscm.fwk.base.ProcessUnit{
	public PPLA004(){
		super();
	}
	...
	*/
	public IDataSet pPLA00401 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA004 fu = (FPLA004) lookupFunctionUnit(FPLA004.class);
			IDataSet ds = fu.fPLA004QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA00402 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA004 fu = (FPLA004) lookupFunctionUnit(FPLA004.class);
			IDataSet ds = fu.fPLA004QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA00403 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA004 fu = (FPLA004) lookupFunctionUnit(FPLA004.class);
			IDataSet ds = fu.fPLA004QrySelectRevPeriod(requestData, onlineCtx);
