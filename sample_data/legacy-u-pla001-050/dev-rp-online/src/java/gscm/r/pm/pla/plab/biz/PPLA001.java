...
*/
public class PPLA001 extends gscm.fwk.base.ProcessUnit{
	public PPLA001(){
		super();
	}
	...
	*/
	public IDataSet pPLA00101 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA001 fu = (FPLA001) lookupFunctionUnit(FPLA001.class);
			IDataSet ds = fu.fPLA001QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA00102 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA001 fu = (FPLA001) lookupFunctionUnit(FPLA001.class);
			IDataSet ds = fu.fPLA001QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA00103 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA001 fu = (FPLA001) lookupFunctionUnit(FPLA001.class);
			IDataSet ds = fu.fPLA001QrySelectRevPeriod(requestData, onlineCtx);
