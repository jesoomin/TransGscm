...
*/
public class PPLA016 extends gscm.fwk.base.ProcessUnit{
	public PPLA016(){
		super();
	}
	...
	*/
	public IDataSet pPLA01601 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA016 fu = (FPLA016) lookupFunctionUnit(FPLA016.class);
			IDataSet ds = fu.fPLA016QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA01602 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA016 fu = (FPLA016) lookupFunctionUnit(FPLA016.class);
			IDataSet ds = fu.fPLA016QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA01603 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA016 fu = (FPLA016) lookupFunctionUnit(FPLA016.class);
			IDataSet ds = fu.fPLA016QrySelectRevPeriod(requestData, onlineCtx);
