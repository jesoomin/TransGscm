...
*/
public class PPLA037 extends gscm.fwk.base.ProcessUnit{
	public PPLA037(){
		super();
	}
	...
	*/
	public IDataSet pPLA03701 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA037 fu = (FPLA037) lookupFunctionUnit(FPLA037.class);
			IDataSet ds = fu.fPLA037QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA03702 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA037 fu = (FPLA037) lookupFunctionUnit(FPLA037.class);
			IDataSet ds = fu.fPLA037QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA03703 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA037 fu = (FPLA037) lookupFunctionUnit(FPLA037.class);
			IDataSet ds = fu.fPLA037QrySelectRevPeriod(requestData, onlineCtx);
