...
*/
public class PPLA045 extends gscm.fwk.base.ProcessUnit{
	public PPLA045(){
		super();
	}
	...
	*/
	public IDataSet pPLA04501 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA045 fu = (FPLA045) lookupFunctionUnit(FPLA045.class);
			IDataSet ds = fu.fPLA045QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA04502 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA045 fu = (FPLA045) lookupFunctionUnit(FPLA045.class);
			IDataSet ds = fu.fPLA045QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA04503 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA045 fu = (FPLA045) lookupFunctionUnit(FPLA045.class);
			IDataSet ds = fu.fPLA045QrySelectRevPeriod(requestData, onlineCtx);
