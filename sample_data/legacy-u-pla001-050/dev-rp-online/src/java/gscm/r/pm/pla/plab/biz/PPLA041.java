...
*/
public class PPLA041 extends gscm.fwk.base.ProcessUnit{
	public PPLA041(){
		super();
	}
	...
	*/
	public IDataSet pPLA04101 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA041 fu = (FPLA041) lookupFunctionUnit(FPLA041.class);
			IDataSet ds = fu.fPLA041QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA04102 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA041 fu = (FPLA041) lookupFunctionUnit(FPLA041.class);
			IDataSet ds = fu.fPLA041QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA04103 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA041 fu = (FPLA041) lookupFunctionUnit(FPLA041.class);
			IDataSet ds = fu.fPLA041QrySelectRevPeriod(requestData, onlineCtx);
