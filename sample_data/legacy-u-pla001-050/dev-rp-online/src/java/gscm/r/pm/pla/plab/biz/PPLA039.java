...
*/
public class PPLA039 extends gscm.fwk.base.ProcessUnit{
	public PPLA039(){
		super();
	}
	...
	*/
	public IDataSet pPLA03901 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA039 fu = (FPLA039) lookupFunctionUnit(FPLA039.class);
			IDataSet ds = fu.fPLA039QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA03902 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA039 fu = (FPLA039) lookupFunctionUnit(FPLA039.class);
			IDataSet ds = fu.fPLA039QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA03903 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA039 fu = (FPLA039) lookupFunctionUnit(FPLA039.class);
			IDataSet ds = fu.fPLA039QrySelectRevPeriod(requestData, onlineCtx);
