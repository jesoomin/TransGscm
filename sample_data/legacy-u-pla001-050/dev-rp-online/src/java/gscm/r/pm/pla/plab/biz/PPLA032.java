...
*/
public class PPLA032 extends gscm.fwk.base.ProcessUnit{
	public PPLA032(){
		super();
	}
	...
	*/
	public IDataSet pPLA03201 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA032 fu = (FPLA032) lookupFunctionUnit(FPLA032.class);
			IDataSet ds = fu.fPLA032QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA03202 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA032 fu = (FPLA032) lookupFunctionUnit(FPLA032.class);
			IDataSet ds = fu.fPLA032QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA03203 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA032 fu = (FPLA032) lookupFunctionUnit(FPLA032.class);
			IDataSet ds = fu.fPLA032QrySelectRevPeriod(requestData, onlineCtx);
