...
*/
public class PPLA044 extends gscm.fwk.base.ProcessUnit{
	public PPLA044(){
		super();
	}
	...
	*/
	public IDataSet pPLA04401 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA044 fu = (FPLA044) lookupFunctionUnit(FPLA044.class);
			IDataSet ds = fu.fPLA044QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA04402 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA044 fu = (FPLA044) lookupFunctionUnit(FPLA044.class);
			IDataSet ds = fu.fPLA044QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA04403 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA044 fu = (FPLA044) lookupFunctionUnit(FPLA044.class);
			IDataSet ds = fu.fPLA044QrySelectRevPeriod(requestData, onlineCtx);
