...
*/
public class PPLA013 extends gscm.fwk.base.ProcessUnit{
	public PPLA013(){
		super();
	}
	...
	*/
	public IDataSet pPLA01301 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA013 fu = (FPLA013) lookupFunctionUnit(FPLA013.class);
			IDataSet ds = fu.fPLA013QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA01302 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA013 fu = (FPLA013) lookupFunctionUnit(FPLA013.class);
			IDataSet ds = fu.fPLA013QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA01303 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA013 fu = (FPLA013) lookupFunctionUnit(FPLA013.class);
			IDataSet ds = fu.fPLA013QrySelectRevPeriod(requestData, onlineCtx);
