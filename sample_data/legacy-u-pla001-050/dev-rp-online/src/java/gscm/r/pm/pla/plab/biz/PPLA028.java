...
*/
public class PPLA028 extends gscm.fwk.base.ProcessUnit{
	public PPLA028(){
		super();
	}
	...
	*/
	public IDataSet pPLA02801 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA028 fu = (FPLA028) lookupFunctionUnit(FPLA028.class);
			IDataSet ds = fu.fPLA028QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA02802 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA028 fu = (FPLA028) lookupFunctionUnit(FPLA028.class);
			IDataSet ds = fu.fPLA028QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA02803 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA028 fu = (FPLA028) lookupFunctionUnit(FPLA028.class);
			IDataSet ds = fu.fPLA028QrySelectRevPeriod(requestData, onlineCtx);
