...
*/
public class PPLA005 extends gscm.fwk.base.ProcessUnit{
	public PPLA005(){
		super();
	}
	...
	*/
	public IDataSet pPLA00501 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA005 fu = (FPLA005) lookupFunctionUnit(FPLA005.class);
			IDataSet ds = fu.fPLA005QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA00502 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA005 fu = (FPLA005) lookupFunctionUnit(FPLA005.class);
			IDataSet ds = fu.fPLA005QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA00503 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA005 fu = (FPLA005) lookupFunctionUnit(FPLA005.class);
			IDataSet ds = fu.fPLA005QrySelectRevPeriod(requestData, onlineCtx);
