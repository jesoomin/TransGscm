...
*/
public class PPLA036 extends gscm.fwk.base.ProcessUnit{
	public PPLA036(){
		super();
	}
	...
	*/
	public IDataSet pPLA03601 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA036 fu = (FPLA036) lookupFunctionUnit(FPLA036.class);
			IDataSet ds = fu.fPLA036QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA03602 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA036 fu = (FPLA036) lookupFunctionUnit(FPLA036.class);
			IDataSet ds = fu.fPLA036QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA03603 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA036 fu = (FPLA036) lookupFunctionUnit(FPLA036.class);
			IDataSet ds = fu.fPLA036QrySelectRevPeriod(requestData, onlineCtx);
