...
*/
public class PPLA038 extends gscm.fwk.base.ProcessUnit{
	public PPLA038(){
		super();
	}
	...
	*/
	public IDataSet pPLA03801 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA038 fu = (FPLA038) lookupFunctionUnit(FPLA038.class);
			IDataSet ds = fu.fPLA038QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA03802 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA038 fu = (FPLA038) lookupFunctionUnit(FPLA038.class);
			IDataSet ds = fu.fPLA038QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA03803 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA038 fu = (FPLA038) lookupFunctionUnit(FPLA038.class);
			IDataSet ds = fu.fPLA038QrySelectRevPeriod(requestData, onlineCtx);
