...
*/
public class PPLA011 extends gscm.fwk.base.ProcessUnit{
	public PPLA011(){
		super();
	}
	...
	*/
	public IDataSet pPLA01101 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA011 fu = (FPLA011) lookupFunctionUnit(FPLA011.class);
			IDataSet ds = fu.fPLA011QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA01102 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA011 fu = (FPLA011) lookupFunctionUnit(FPLA011.class);
			IDataSet ds = fu.fPLA011QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA01103 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA011 fu = (FPLA011) lookupFunctionUnit(FPLA011.class);
			IDataSet ds = fu.fPLA011QrySelectRevPeriod(requestData, onlineCtx);
