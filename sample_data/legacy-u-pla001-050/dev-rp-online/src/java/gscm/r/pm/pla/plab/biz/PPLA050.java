...
*/
public class PPLA050 extends gscm.fwk.base.ProcessUnit{
	public PPLA050(){
		super();
	}
	...
	*/
	public IDataSet pPLA05001 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA050 fu = (FPLA050) lookupFunctionUnit(FPLA050.class);
			IDataSet ds = fu.fPLA050QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA05002 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA050 fu = (FPLA050) lookupFunctionUnit(FPLA050.class);
			IDataSet ds = fu.fPLA050QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA05003 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA050 fu = (FPLA050) lookupFunctionUnit(FPLA050.class);
			IDataSet ds = fu.fPLA050QrySelectRevPeriod(requestData, onlineCtx);
