...
*/
public class PPLA048 extends gscm.fwk.base.ProcessUnit{
	public PPLA048(){
		super();
	}
	...
	*/
	public IDataSet pPLA04801 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA048 fu = (FPLA048) lookupFunctionUnit(FPLA048.class);
			IDataSet ds = fu.fPLA048QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA04802 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA048 fu = (FPLA048) lookupFunctionUnit(FPLA048.class);
			IDataSet ds = fu.fPLA048QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA04803 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA048 fu = (FPLA048) lookupFunctionUnit(FPLA048.class);
			IDataSet ds = fu.fPLA048QrySelectRevPeriod(requestData, onlineCtx);
