...
*/
public class PPLA018 extends gscm.fwk.base.ProcessUnit{
	public PPLA018(){
		super();
	}
	...
	*/
	public IDataSet pPLA01801 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA018 fu = (FPLA018) lookupFunctionUnit(FPLA018.class);
			IDataSet ds = fu.fPLA018QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA01802 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA018 fu = (FPLA018) lookupFunctionUnit(FPLA018.class);
			IDataSet ds = fu.fPLA018QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA01803 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA018 fu = (FPLA018) lookupFunctionUnit(FPLA018.class);
			IDataSet ds = fu.fPLA018QrySelectRevPeriod(requestData, onlineCtx);
