...
*/
public class PPLA020 extends gscm.fwk.base.ProcessUnit{
	public PPLA020(){
		super();
	}
	...
	*/
	public IDataSet pPLA02001 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA020 fu = (FPLA020) lookupFunctionUnit(FPLA020.class);
			IDataSet ds = fu.fPLA020QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA02002 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA020 fu = (FPLA020) lookupFunctionUnit(FPLA020.class);
			IDataSet ds = fu.fPLA020QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA02003 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA020 fu = (FPLA020) lookupFunctionUnit(FPLA020.class);
			IDataSet ds = fu.fPLA020QrySelectRevPeriod(requestData, onlineCtx);
