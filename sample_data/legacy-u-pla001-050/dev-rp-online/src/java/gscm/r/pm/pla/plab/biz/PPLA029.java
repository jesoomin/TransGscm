...
*/
public class PPLA029 extends gscm.fwk.base.ProcessUnit{
	public PPLA029(){
		super();
	}
	...
	*/
	public IDataSet pPLA02901 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA029 fu = (FPLA029) lookupFunctionUnit(FPLA029.class);
			IDataSet ds = fu.fPLA029QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA02902 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA029 fu = (FPLA029) lookupFunctionUnit(FPLA029.class);
			IDataSet ds = fu.fPLA029QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA02903 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA029 fu = (FPLA029) lookupFunctionUnit(FPLA029.class);
			IDataSet ds = fu.fPLA029QrySelectRevPeriod(requestData, onlineCtx);
