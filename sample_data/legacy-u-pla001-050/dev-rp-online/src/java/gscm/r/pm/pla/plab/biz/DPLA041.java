...
*/
public class DPLA041 extends gscm.fwk.base.ProcessUnit{
	public DPLA041(){
		super();
	}
	...
	*/
	public IDataSet dPLA04101(IDataSet requestData, IOnlineContext onlineCtx){
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA04102(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA04103(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA04104(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA04105(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA04106(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
