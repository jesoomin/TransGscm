...
*/
public class PPLA022 extends gscm.fwk.base.ProcessUnit{
	public PPLA022(){
		super();
	}
	...
	*/
	public IDataSet pPLA02201 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA022 fu = (FPLA022) lookupFunctionUnit(FPLA022.class);
			IDataSet ds = fu.fPLA022QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA02202 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA022 fu = (FPLA022) lookupFunctionUnit(FPLA022.class);
			IDataSet ds = fu.fPLA022QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA02203 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA022 fu = (FPLA022) lookupFunctionUnit(FPLA022.class);
			IDataSet ds = fu.fPLA022QrySelectRevPeriod(requestData, onlineCtx);
