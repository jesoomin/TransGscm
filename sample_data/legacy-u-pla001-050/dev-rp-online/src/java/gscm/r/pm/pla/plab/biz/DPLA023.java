...
*/
public class DPLA023 extends gscm.fwk.base.ProcessUnit{
	public DPLA023(){
		super();
	}
	...
	*/
	public IDataSet dPLA02301(IDataSet requestData, IOnlineContext onlineCtx){
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA02302(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA02303(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA02304(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA02305(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA02306(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
