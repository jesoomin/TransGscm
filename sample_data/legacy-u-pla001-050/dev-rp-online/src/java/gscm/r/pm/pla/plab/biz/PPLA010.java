...
*/
public class PPLA010 extends gscm.fwk.base.ProcessUnit{
	public PPLA010(){
		super();
	}
	...
	*/
	public IDataSet pPLA01001 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA010 fu = (FPLA010) lookupFunctionUnit(FPLA010.class);
			IDataSet ds = fu.fPLA010QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA01002 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA010 fu = (FPLA010) lookupFunctionUnit(FPLA010.class);
			IDataSet ds = fu.fPLA010QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA01003 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA010 fu = (FPLA010) lookupFunctionUnit(FPLA010.class);
			IDataSet ds = fu.fPLA010QrySelectRevPeriod(requestData, onlineCtx);
