...
*/
public class PPLA026 extends gscm.fwk.base.ProcessUnit{
	public PPLA026(){
		super();
	}
	...
	*/
	public IDataSet pPLA02601 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA026 fu = (FPLA026) lookupFunctionUnit(FPLA026.class);
			IDataSet ds = fu.fPLA026QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA02602 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA026 fu = (FPLA026) lookupFunctionUnit(FPLA026.class);
			IDataSet ds = fu.fPLA026QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA02603 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA026 fu = (FPLA026) lookupFunctionUnit(FPLA026.class);
			IDataSet ds = fu.fPLA026QrySelectRevPeriod(requestData, onlineCtx);
