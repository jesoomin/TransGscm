...
*/
public class DPLA049 extends gscm.fwk.base.ProcessUnit{
	public DPLA049(){
		super();
	}
	...
	*/
	public IDataSet dPLA04901(IDataSet requestData, IOnlineContext onlineCtx){
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA04902(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA04903(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA04904(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA04905(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet dPLA04906(IDataSet requestData, IOnlineContext onlineCtx){
		IDataSet responseData = new DataSet();
