...
*/
public class PPLA006 extends gscm.fwk.base.ProcessUnit{
	public PPLA006(){
		super();
	}
	...
	*/
	public IDataSet pPLA00601 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA006 fu = (FPLA006) lookupFunctionUnit(FPLA006.class);
			IDataSet ds = fu.fPLA006QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA00602 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA006 fu = (FPLA006) lookupFunctionUnit(FPLA006.class);
			IDataSet ds = fu.fPLA006QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA00603 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA006 fu = (FPLA006) lookupFunctionUnit(FPLA006.class);
			IDataSet ds = fu.fPLA006QrySelectRevPeriod(requestData, onlineCtx);
