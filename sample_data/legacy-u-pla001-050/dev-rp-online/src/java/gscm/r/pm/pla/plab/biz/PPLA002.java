...
*/
public class PPLA002 extends gscm.fwk.base.ProcessUnit{
	public PPLA002(){
		super();
	}
	...
	*/
	public IDataSet pPLA00201 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA002 fu = (FPLA002) lookupFunctionUnit(FPLA002.class);
			IDataSet ds = fu.fPLA002QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA00202 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA002 fu = (FPLA002) lookupFunctionUnit(FPLA002.class);
			IDataSet ds = fu.fPLA002QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA00203 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA002 fu = (FPLA002) lookupFunctionUnit(FPLA002.class);
			IDataSet ds = fu.fPLA002QrySelectRevPeriod(requestData, onlineCtx);
