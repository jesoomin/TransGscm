...
*/
public class PPLA031 extends gscm.fwk.base.ProcessUnit{
	public PPLA031(){
		super();
	}
	...
	*/
	public IDataSet pPLA03101 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA031 fu = (FPLA031) lookupFunctionUnit(FPLA031.class);
			IDataSet ds = fu.fPLA031QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA03102 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA031 fu = (FPLA031) lookupFunctionUnit(FPLA031.class);
			IDataSet ds = fu.fPLA031QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA03103 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA031 fu = (FPLA031) lookupFunctionUnit(FPLA031.class);
			IDataSet ds = fu.fPLA031QrySelectRevPeriod(requestData, onlineCtx);
