...
*/
public class PPLA012 extends gscm.fwk.base.ProcessUnit{
	public PPLA012(){
		super();
	}
	...
	*/
	public IDataSet pPLA01201 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA012 fu = (FPLA012) lookupFunctionUnit(FPLA012.class);
			IDataSet ds = fu.fPLA012QrySelectMainList(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA01202 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA012 fu = (FPLA012) lookupFunctionUnit(FPLA012.class);
			IDataSet ds = fu.fPLA012QrySelectRev(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	*/
	public IDataSet pPLA01203 (IDataSet){
		IDataSet responseData = new DataSet();
		try{
			FPLA012 fu = (FPLA012) lookupFunctionUnit(FPLA012.class);
			IDataSet ds = fu.fPLA012QrySelectRevPeriod(requestData, onlineCtx);
